...
tags: [ ruby, rails ]
---
When I was just starting to learn Ruby on Rails I had problems setting up
multiple associatioes using the same model due to my lack of understanding and
reliance on Rail's "magical" generators to generate the database schema. Here
I'll show you how to implement it and analyze how it happens. On this example
there are two models, User and TransferRequest. TransferRequest has attributes
sender and receiver which are instances of User.
